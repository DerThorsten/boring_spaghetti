...
different stop condition as in EHC, and stop only if a certain number of connected
...
As this implementation uses full adjacency matrices it does not scale as well and can not be applied on all datasets.
