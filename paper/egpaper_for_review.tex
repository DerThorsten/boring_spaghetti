...
\begin{table}[t]
   ...
   \begin{tabular}{lllllll}
      ...
      \midrule 
         ...
         FUSION           &$\bf 2.1406$  &    $ 2.8787$ &    $ 4.0744$   &    $ 4.6616$ &    --        & $       6.5366$ \\
...
\begin{table}[t]
   \tiny
   \centering
   \caption{Evaluation of Rand Index (RI) for datasets with available ground-truth.}
   \label{tab:eval2}
   \begin{tabular}{lllllll}
      \toprule
         Dataset          &  image-seg   & knott-3d-150 & knott-3d-300   & knott-3d-450 & knott-3d-550 &3d-seg\\
      \midrule 
         ...
         MC-R             &   $ 0.7822$  &    $ 0.9232$ & $\bf  0.8849$  &    $ 0.6713$ &    --        & $ 0.0432$ \\   
         MC-I             &   $ 0.7821$  & $\bf 0.9236$ & $\bf  0.8849$  & $\bf 0.8670$ &    --        & $ 0.5461$\\  
