...
For the latter we use a maximal number of iterations and maximal number of iteration without improvement as stopping condition.
...
The level of noise has to be large enough to generate diverse proposals, but not too large which would lead to proposals with low quality.
...
outperform state-of-the-art solvers w.r.t. any time performance 
