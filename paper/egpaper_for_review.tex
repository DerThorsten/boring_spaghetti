...
the node coloring is ambiguous and has no semantic meaning (see Fig.~\ref{fig:fusion_abiguty}).
...
and optimize the subproblems as described in 
Sec.~\ref{sec:fast_optimization} (see Fig. \ref{fig:move_graph}).
