...
\begin{proof}
Let $y'$ be the back propagation of $\bar{y}^*$, which is by definition a feasible solution of~\ref{eq:fusion_move_a}.
If 

Since $\bar{y}^*$ fulfills all-must link constraints of~\ref{eq:fusion_move_a} it is a feasible solution.
Let

, we have  $y^*\cdot w = \rho^{-1}_y(y^*)\cdot \bar{w}$.
