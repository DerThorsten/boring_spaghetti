...
Cut, Clue \& Cut~\cite{beier_2014_cvpr} (\textbf{CGC}): We used the public available implementation\footnote{\label{opengm-cvpr2014}\url{https://github.com/opengm/opengm/tree/cgc-cvpr2014}}
of the original authors.
\textbf{KL}~\cite{Kerninghan-1970}: We use the the  public available 
        implementation 
