...
We also run classical fusion moves~\cite{Lempinsky-2010} (\textbf{Fusion}) and select distinct labels for the two candidate segmentations.
...
\textbf{fusionCC-HC-CGC},
\textbf{fusionCC-WS-MC}, and 
\textbf{fusionCC-WS-CGC}, respectively.
...
>>>>>>> 648908c8592b416780ef00b0cfa7a53660f47c83
