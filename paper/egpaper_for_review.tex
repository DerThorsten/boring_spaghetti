...
\subsubsection{Randomized Energy Based Hierarchical Clustering (REHC)}\label{sec:prop:hc}
...
\subsubsection{Randomized Watersheds (RWS)}\label{sec:prop:ws}
...
\item \textbf{Fusion-EHC-MC}
\item \textbf{Fusion-EHC-GCG}
\item \textbf{Fusion-WS-MC}
\item \textbf{Fusion-WS-GCG}
