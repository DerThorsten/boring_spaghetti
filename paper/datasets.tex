...
This is a who-trust-whom online social network of a a general consumer review site. 
...
\end{align}
which is zero if the given partitioning does not violates any relation and larger otherwise.
...
We also request larger instances from the authors of~\cite{kroeger_2012_eccv} who kindly provide us the dataset~\emph{knott-3d-550} with cube size  $550^3$.
