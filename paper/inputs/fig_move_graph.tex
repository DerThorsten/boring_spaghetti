...
%\begin{subfigure}[t]{1\linewidth}
   \resizebox{1.0\linewidth}{!}{
      \begin{tikzpicture}[scale=1.0,transform shape]
        ...
        \draw (16+0*2,    3*2) node[vert](1){$\{1\}$};
        \draw (16+2*2,    3*2) node[vert](2){$\{2, 3, 4\}$};
        \draw (16+0*2,    2*2) node[vert,](5){$\{5\}$};
        \draw (16+2*2,    2*2) node[vert](6){$\{6, 7, 8\}$};
        \draw (16+0*2,    1*2) node[vert](9){$\{9, 13\}$};
        \draw (16+2*2+0.5,1*2-0.5) node[vert ](10){$\{10, 11, 12,14, 15, 16\}$};
        %
        \path[every node/.style={font=\sffamily\tiny, fill=white}]
            (1)     edge[aedge]     node{$w_{(1, 2)}$   }     (2)
            (1)     edge[aedge]     node{$w_{(1, 5)}$   }     (5)
        ...
        \draw (24+0*2,0+3*2) node[vert,fill=blue!20!cyan](1){$\{1\}$};
        \draw (24+2*2,0+3*2) node[vert,fill=green!30!cyan](2){$\{2, 3, 4\}$};
        \draw (24+0*2,0+2*2) node[vert,fill=blue!20!cyan ](5){$\{5\}$};
        \draw (24+2*2,0+2*2) node[vert,fill=blue!40!green](6){$\{6, 7, 8\}$};
        \draw (24+0*2,0+1*2) node[vert,fill=blue!40!green](9){$\{9, 13\}$};
        \draw (24+2*2+0.5,0+0.811*2-0.5) node[vert,fill=blue!40!green](10){$\{10, 11, 12,14, 15, 16\}$};
        %
        \path[every node/.style={font=\sffamily\tiny, fill=white}]
            (1)     edge[cedge]     node{$w_{(1, 2)}$   }     (2)
            (1)     edge[cedge]     node{$w_{(1, 5)}$   }     (5)
        ...
        \draw (32+0*2,0+3*2) node[vert,fill=blue!20!cyan](1){$1$};
        \draw (32+1*2,0+3*2) node[vert,fill=green!30!cyan](2){$2$};
        \draw (32+2*2,0+3*2) node[vert,fill=green!30!cyan](3){$3$};
        \draw (32+3*2,0+3*2) node[vert,fill=green!30!cyan](4){$4$};
        \draw (32+0*2,0+2*2) node[vert,fill=blue!20!cyan](5){$5$};
        \draw (32+1*2,0+2*2) node[vert,fill=blue!40!green](6){$6$};
        \draw (32+2*2,0+2*2) node[vert,fill=blue!40!green](7){$7$};
        \draw (32+3*2,0+2*2) node[vert,fill=blue!40!green](8){$8$};
        \draw (32+0*2,0+1*2) node[vert,fill=blue!40!green](9){$9$};
        \draw (32+1*2,0+1*2) node[vert,fill=blue!40!green](10){$10$};
        \draw (32+2*2,0+1*2) node[vert,fill=blue!40!green](11){$11$};
        \draw (32+3*2,0+1*2) node[vert,fill=blue!40!green](12){$12$};
        \draw (32+0*2,0+0*2) node[vert,fill=blue!40!green](13){$13$};
        \draw (32+1*2,0+0*2) node[vert,fill=blue!40!green](14){$14$};
        \draw (32+2*2,0+0*2) node[vert,fill=blue!40!green](15){$15$};
        \draw (32+3*2,0+0*2) node[vert,fill=blue!40!green](16){$16$};
        %
        \path[every node/.style={font=\sffamily\tiny, fill=white}]
            (1)     edge[cedge]     node{$w_{(1, 2)}$   }     (2)
            (2)     edge[aedge]     node{$w_{(2, 3)}$   }     (3)
