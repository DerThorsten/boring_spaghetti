...
%\begin{subfigure}[t]{1\linewidth}
   \resizebox{1.0\linewidth}{!}{
      \begin{tikzpicture}[scale=1.0,transform shape]
        ...
        \draw (15.5+0*2, 1+5) node[minimum size=2cm,font=\sffamily\Huge] (dummy){$\rightarrow$};
        \draw (15.5+0*2,-1+5) node[rotate=90,minimum size=2cm,font=\sffamily\huge] (dummy){$\textbf{contract}$};
        \draw (15.5+0*2,-3+5) node[minimum size=2cm,font=\sffamily\Huge] (dummy){$\rightarrow$};
        ...
        \draw (23.7+0*2, 1+5) node[minimum size=2cm,font=\sffamily\Huge] (dummy){$\rightarrow$};
        \draw (23.7+0*2,-1+5) node[rotate=90,minimum size=2cm,font=\sffamily\huge] (dummy){$\textbf{run CC}$};
        \draw (23.7+0*2,-3+5) node[minimum size=2cm,font=\sffamily\Huge] (dummy){$\rightarrow$};

        \draw (26+0*2,0+3*2) node[vert,fill=blue!20!cyan](1){$\{1\}$};
        \draw (26+2*2,0+3*2) node[vert,fill=green!30!cyan](2){$\{2, 3, 4\}$};
        \draw (26+0*2,0+2*2) node[vert,fill=blue!20!cyan ](5){$\{5\}$};
        \draw (26+2*2,0+2*2) node[vert,fill=blue!40!green](6){$\{6, 7, 8\}$};
        \draw (26+0*2,0+1*2) node[vert,fill=blue!40!green](9){$\{9, 13\}$};
        \draw (26+2*2,0+ 1*2) node[vert,fill=blue!40!green](10){$\{10, 11, 12,$\\$14, 15, 16\}$};
        %
        \path[every node/.style={font=\sffamily\tiny, fill=white}]
            (1)     edge[cedge]     node{$w_{(1, 2)}$   }     (2)
            (1)     edge[cedge]     node{$w_{(1, 5)}$   }     (5)
        ...
        \draw (32.7+0*2, 1+5) node[minimum size=2cm,font=\sffamily\Huge] (dummy){$\rightarrow$};
        \draw (32.7+0*2,-1+5) node[rotate=90,minimum size=2cm,font=\sffamily\huge] (dummy){$\textbf{project}$};
        \draw (32.7+0*2,-3+5) node[minimum size=2cm,font=\sffamily\Huge] (dummy){$\rightarrow$};


        \draw (35+0*2,0+3*2) node[vert,fill=blue!20!cyan](1){$1$};
        \draw (35+1*2,0+3*2) node[vert,fill=green!30!cyan](2){$2$};
        \draw (35+2*2,0+3*2) node[vert,fill=green!30!cyan](3){$3$};
        \draw (35+3*2,0+3*2) node[vert,fill=green!30!cyan](4){$4$};
        \draw (35+0*2,0+2*2) node[vert,fill=blue!20!cyan](5){$5$};
        \draw (35+1*2,0+2*2) node[vert,fill=blue!40!green](6){$6$};
        \draw (35+2*2,0+2*2) node[vert,fill=blue!40!green](7){$7$};
        \draw (35+3*2,0+2*2) node[vert,fill=blue!40!green](8){$8$};
        \draw (35+0*2,0+1*2) node[vert,fill=blue!40!green](9){$9$};
        \draw (35+1*2,0+1*2) node[vert,fill=blue!40!green](10){$10$};
        \draw (35+2*2,0+1*2) node[vert,fill=blue!40!green](11){$11$};
        \draw (35+3*2,0+1*2) node[vert,fill=blue!40!green](12){$12$};
        \draw (35+0*2,0+0*2) node[vert,fill=blue!40!green](13){$13$};
        \draw (35+1*2,0+0*2) node[vert,fill=blue!40!green](14){$14$};
        \draw (35+2*2,0+0*2) node[vert,fill=blue!40!green](15){$15$};
        \draw (35+3*2,0+0*2) node[vert,fill=blue!40!green](16){$16$};
        %
        \path[every node/.style={font=\sffamily\tiny, fill=white}]
            (1)     edge[cedge]     node{$w_{(1, 2)}$   }     (2)
            (2)     edge[aedge]     node{$w_{(2, 3)}$   }     (3)
        ...
        \draw[line width=6pt]     (35+2.5*2,3*2+1) -- (35+2.5*2,3*2+4);
        \draw[line width=6pt, ->] (35+2.5*2,3*2+4) -- (7,3*2+4); 
        ...
        \draw[line width=6pt] (24+2.5*2,3*2+1) edge [bend left=40,->] (31+2.5*2,3*2+1);
      \end{tikzpicture}
   } 
