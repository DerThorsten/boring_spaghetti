...
\resizebox{\linewidth}{!}{
    \begin{tikzpicture}[scale=1]%[x=1 cm, y=1 cm]
            ...
            (1-1.5,3.5) -- (1-1.5,6.5) node [black,midway,xshift=-1.2cm,rotate=90,align=left] 
            {\Large{proposal edge} \\ \Large{labeling \quad $\bm{x'}$}};

            \draw [decorate,decoration={brace,amplitude=10pt},xshift=-4pt,yshift=0pt]
            (1-1.5,3-3.5) -- (1-1.5,6.5-4) node [black,midway,xshift=-1.2cm, rotate=90,align=left] 
            {\Large{proposal edge} \\ \Large{labeling \quad $\bm{x''}$}};


            \draw [decorate,decoration={brace,amplitude=10pt},xshift=-4pt,yshift=0pt]
            (5,3.5) -- (5,6.5) node [black,midway,xshift=-1.2cm,rotate=90,align=left] 
            {\Large{proposal node} \\ \Large{labeling \quad $\bm{l'}$}};
            ...
            {\Large{Binary fusion} \\ \Large{move problem}};
            ...
            {
                \Large{For all different colorings $\bm{l''}$, the binary fusion move subproblem is different.}
            };
            ...
            {
                \Large{All these node labelings encode the same partition}
            };
...
\caption{
todo: write me (why normal fusion does not work)
