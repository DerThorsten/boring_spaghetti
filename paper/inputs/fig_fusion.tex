...
\begin{subfigure}[t]{0.7\linewidth}
    \resizebox{\linewidth}{!}{
        \begin{tikzpicture}[scale=1]%[x=1 cm, y=1 cm]
                ...
                % 2. FUSION
                \draw (2+8,2) node[nS,fill=blue!60] (n0) {$0$}; 
                \draw (4+8,2) node[nS,fill=green!60] (n1) {$1$};
                \draw (2+8,0) node[nS,fill=blue!60] (n3) {$2$}; 
                \draw (4+8,0) node[nS,fill=green!60] (n4) {$3$};
                \path
                    (n0) edge[eS] node[eNS]{$w_{01}$} (n1) 
                    (n3) edge[eS] node[eNS]{$w_{23}$} (n4) 
                    (n0) edge[eS] node[eNS]{$w_{02}$} (n3)
                ...
                \draw (2+8,2-4) node[nD, circle split part fill={red!60, blue!60}] (n0) {$ $}; 
                \draw (4+8,2-4) node[nD, circle split part fill={red!60, green!60}] (n1) {$ $};
                \draw (2+8,0-4) node[nD, circle split part fill={green!60, blue!60}] (n3) {$ $}; 
                ...
                % 3. FUSION
                \draw (2+12,2) node[nS,fill=red!60] (n0) {$0$}; 
                \draw (4+12,2) node[nS,fill=blue!60] (n1) {$1$};
                \draw (2+12,0) node[nS,fill=red!60] (n3) {$2$}; 
                \draw (4+12,0) node[nS,fill=blue!60] (n4) {$3$};
                \path
                    (n0) edge[eS] node[eNS]{$w_{01}$} (n1) 
                    (n3) edge[eS] node[eNS]{$w_{23}$} (n4) 
                    (n0) edge[eS] node[eNS]{$w_{02}$} (n3)
                ...
                \draw (2+12,2-4) node[nD, circle split part fill={red!60, red!60}] (n0) {$ $}; 
                \draw (4+12,2-4) node[nD, circle split part fill={red!60, blue!60}] (n1) {$ $};
                \draw (2+12,0-4) node[nD, circle split part fill={green!60, red!60}] (n3) {$ $}; 
                \draw (4+12,0-4) node[nD, circle split part fill={green!60, green!60}] (n4) {$ $};
                \path
                    (n0) edge[eS] node[eNS]{$w_{01}$} (n1) 
                    (n3) edge[eS] node[eNS]{$w_{23}$} (n4) 
                    (n0) edge[eS] node[eNS]{$w_{02}$} (n3)
                ...
                % 4. FUSION
                \draw (2+16,2) node[nS,fill=magenta!60] (n0) {$0$}; 
                \draw (4+16,2) node[nS,fill=blue!60] (n1) {$1$};
                \draw (2+16,0) node[nS,fill=magenta!60] (n3) {$2$}; 
                ...
                \draw (2+16,2-4) node[nD, circle split part fill={red!60, magenta!60}] (n0) {$ $}; 
                \draw (4+16,2-4) node[nD, circle split part fill={red!60, blue!60}] (n1) {$ $};
                \draw (2+16,0-4) node[nD, circle split part fill={green!60, magenta!60}] (n3) {$ $}; 
